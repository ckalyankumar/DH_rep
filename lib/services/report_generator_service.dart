    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Row(
          ...
          children: [
            pw.Text(
              'Siequi — For review by a licensed dermatologist only',
              style: pw.TextStyle(
                fontSize: 8,
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 6),
          pw.Text(
            'Data source: All data is patient self-reported via the Siequi mobile application. '
          ...
          if (includeRiskScore)
            pw.Text(
              ...
              '(Siequi Scoring Engine v1, condition-specific weights). Full methodology at siequi.app/scoring.',
              style: const pw.TextStyle(fontSize: 9),
            ),
    ...
    return pw.Column(
      ...
      children: [
        ...
        pw.Text(
          ...
          'Siequi respects your privacy and complies with ABDM guidelines and India\'s data protection standards.',
          style: pw.TextStyle(fontSize: 10),
        ),
      ],
    );
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.Text(
            ...
            'Data sharing with a clinician requires patient-initiated action within the Siequi app.',
            style: const pw.TextStyle(fontSize: 9),
          ),
          pw.SizedBox(height: 4),
          pw.Text(
          ...
          pw.SizedBox(height: 4),
          pw.Text(
            'Data retention: Patient data is retained in accordance with Siequi\'s privacy policy. '
            'Patients may request deletion at any time via the app settings.',
            style: const pw.TextStyle(fontSize: 9),
          ),
          pw.SizedBox(height: 4),
          pw.Text(
            'Regulatory note: Siequi is a wellness and self-management tool. It is not currently classified as a Software as a Medical '
